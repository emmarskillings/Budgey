      ...
      <Container>
        { this.state && this.state.entries &&
          <div>
            ...
            <h3 align='center'>${this.state.category.current_total}</h3>
            <br/>
            <Popup trigger={
                  ...
                  {close => (
                    ...
                    updateHome={this.props.update} state_category={this.state.category} state_entry={this.state.entry} close ={close.bind(this)}/>
                  )}
            </Popup>
